...
export const ADMIN_STUDENTS_PAGE = {
  ...
  TRANSFER_DIALOG: {
    TITLE: 'نقل الطالب',
    SUBTITLE: 'اختر البرنامج والمسار والمستوى لنقل',
    SUBTITLE_SUFFIX: 'إليه.',
    PROGRAM: 'البرنامج',
    PROGRAM_TRACK: 'المسار',
    LEVEL: 'المستوى',
    TRANSFER_BTN: 'نقل الطالب',
    CANCEL: 'إلغاء',
    CURRENT_PROGRAM: 'البرنامج الحالي',
  },
  ALERTS_DIALOG: {
    TITLE: 'تحديث التنبيهات',
    SUBTITLE: 'تحديث عدد التنبيهات للطالب',
    SUBTITLE_SUFFIX: '.',
