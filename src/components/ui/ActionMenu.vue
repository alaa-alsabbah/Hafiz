...
export interface ActionMenuItem {
  id: string
  label: string
  icon?: 'eye' | 'user-plus' | 'email' | 'whatsapp' | 'edit' | 'trash' | 'transfer' | 'alert' | 'custom'
  onClick: () => void
}
    ...
    <Teleport to="body">
      <Transition name="dropdown">
        ...
        >
          ...
          <span v-else-if="item.icon === 'transfer'" class="action-menu__icon action-menu__icon--transfer">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <span v-else-if="item.icon === 'alert'" class="action-menu__icon action-menu__icon--alert">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
